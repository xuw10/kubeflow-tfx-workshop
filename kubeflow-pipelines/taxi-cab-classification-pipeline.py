...
#    column_names='gs://ml-pipeline-playground/tfx/taxi-cab-classification/column-names.json',
    column_names='/mnt/pipelineai/users/kubeflow-pipelines/taxi-cab-classification/column-names.json',
    key_columns='trip_start_timestamp',
#    train='gs://ml-pipeline-playground/tfx/taxi-cab-classification/train.csv',
    train='/mnt/pipelineai/users/kubeflow-pipelines/taxi-cab-classification/train.csv',
#    evaluation='gs://ml-pipeline-playground/tfx/taxi-cab-classification/eval.csv',
    evaluation='/mnt/pipelineai/users/kubeflow-pipelines/taxi-cab-classification/eval.csv',
    mode='local',
#    preprocess_module='gs://ml-pipeline-playground/tfx/taxi-cab-classification/preprocessing.py',
    preprocess_module='/mnt/pipelineai/users/kubeflow-pipelines/taxi-cab-classification/preprocessing.py',
    learning_rate=0.1,
